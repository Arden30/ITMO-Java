...
public class LabWork {
    ...
    public void setMinimalPoint(Long minimalPoint) {
        if (minimalPoint < 0) {
            throw new IllegalArgumentException("Minimal points can't be less than 0, try again!");
        } else {
    ...
    public void setMaximumPoint(Integer maximumPoint) {
        if (maximumPoint < 0) {
            throw new IllegalArgumentException("Maximum points can't be less than 0, try again!");
        } else {
    ...
    public void setPersonalQualitiesMinimum(Long personalQualitiesMinimum) {
        if (personalQualitiesMinimum < 0) {
            throw new IllegalArgumentException("Minimum personal qualities points can't be less than 0, try again!");
        } else {
